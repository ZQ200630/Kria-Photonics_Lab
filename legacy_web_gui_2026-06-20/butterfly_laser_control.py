...
class TecController:
    ...
    def status(self):
        ...
        return {
            ...
            "pid": {
                "kp_reg": self.read("PID_KP"),
                "ki_reg": self.read("PID_KI"),
                "kd_reg": self.read("PID_KD"),
    ...
    def status(self):
        ...
        return {
            ...
            "lock": {
                ...
                "kp_q16": self.read("LOCK_KP"),
                "ki_q16": self.read("LOCK_KI"),
...
class Ada4355Capture:
    ...
    def status(self):
        ...
        return {
            ...
            "monitor_decim_n": self.read("MONITOR_DECIM_N"),
            "monitor_avg": avg,
...
def build_parser():
    ...
    sub.add_parser("tec-stop", help="Stop TEC loop and set manual DAC to 0x800")
