...
class ScientificAlinePlotTests(unittest.TestCase):
    def test_builds_nature_style_axes_with_prominent_labels_and_legend(self):
        ...
        self.assertEqual(axis.xaxis.label.get_fontsize(), 22)
        self.assertEqual(axis.yaxis.label.get_fontsize(), 22)
        self.assertEqual(figure._suptitle.get_fontsize(), 16)
        self.assertTrue(all(label.get_fontsize() == 12 for label in axis.get_xticklabels()))
        self.assertTrue(all(label.get_fontsize() == 12 for label in axis.get_yticklabels()))
        ...
        self.assertTrue(all(text.get_fontsize() == 11 for text in legend.get_texts()))
